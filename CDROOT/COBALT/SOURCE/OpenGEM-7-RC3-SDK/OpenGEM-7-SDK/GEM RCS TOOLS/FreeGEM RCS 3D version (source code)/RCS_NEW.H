...
#define ALERT27 27  	/* STRING */
#define ALERT28 28  	/* STRING */
#define ALERT29 29  	/* STRING */
#define ALERT30 30  	/* STRING */
#define ALERT31 31  	/* STRING */
#define ABNDCHGS 32  	/* STRING */
#define ALERT33 33  	/* STRING */
...
#define TREE28 27  	/* TREE */
#define TREE29 28  	/* TREE */
#define TREE30 29  	/* TREE */
#define TREE31 30  	/* TREE */
#define TREE32 31  	/* TREE */
#define TREE33 32  	/* TREE */
#define TREE34 33  	/* TREE */
#define GRID 34  	/* TREE */
...
#define CROSSPOP 12  	/* OBJECT in TREE #26 */
#define DSBLPOP 13  	/* OBJECT in TREE #26 */
#define SLCTPOP 14  	/* OBJECT in TREE #26 */
#define HDDNPOP 7  	/* OBJECT in TREE #26 */
#define D3DPOP 15  	/* OBJECT in TREE #26 */
#define CCLRPOP 16  	/* OBJECT in TREE #26 */
...
#define INFOITEM 48  	/* OBJECT in TREE #0 */
...
#define ESCCPOP 17  	/* OBJECT in TREE #26 */
#define SCRCPOP 18  	/* OBJECT in TREE #26 */
#define HILIPOP 19  	/* OBJECT in TREE #26 */
#define UNHIPOP 20  	/* OBJECT in TREE #26 */
