...
EXTERN	     LPVOID     src_mp;
EXTERN	     LPVOID     dst_mp;
EXTERN	     GRECT      pbx;
...
EXTERN       VOID       MAGNIFY();
EXTERN	     VOID       B_MOVE(LPVOID from, WORD count, LPVOID to);
EXTERN	     WORD       objc_draw();
EXTERN	     VOID       outl_img();
EXTERN	     VOID       set_fatbox();
